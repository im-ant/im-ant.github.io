    ...
    <div className="flex flex-col sm:flex-row gap-6">
      ...
      <div className="flex flex-col flex-1">
        ...
        <p className="text-sm text-zinc-600 mb-4">
          {highlightAuthor(publication.authors, ["Anthony GX-Chen", "Anthony GX-Chen*"])}
        </p>
        <div className="flex flex-row gap-6">
          ...
          {publication.tweetUrl && (
            <a
              href={publication.tweetUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-2 text-xs text-zinc-500 hover:text-blue-500 transition-colors duration-300"
            >
              <ArrowUpRight
                size={12}
                className="group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform duration-300"
